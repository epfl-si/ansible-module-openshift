...
- name: An ImageStream built from a directory living in a Git depot
  openshift_imagestream:
    ...
    spec:
      # You can merge a homemade spec: section with the
      # one that is auto-generated by the Ansible module,
      # e.g. to set build resource limits:
      resources:
        limits:
          memory: "4G"
"""
